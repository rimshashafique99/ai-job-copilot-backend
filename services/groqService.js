...
async function generateFullAnalysis(jobDescription, cvText) {
  if (process.env.NODE_ENV === 'test') {
    return {
      role: 'Software Engineer',
      coverLetter: 'This is a fake cover letter generated by the test-mode stub.',
      coldEmail: 'This is a fake cold email generated by the test-mode stub.',
      gapAnalysis: 'This is a fake gap analysis generated by the test-mode stub.',
      cvBullets: ['Fake bullet one', 'Fake bullet two', 'Fake bullet three'],
    };
  }
