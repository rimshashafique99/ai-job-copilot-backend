...
async function create({ userId, role = null, companyName, jobDescription = null, jobLink = null, tag = null, stage = 'saved' }) {
  const result = await db.query(
    `INSERT INTO job_applications (user_id, role, company_name, job_description, job_link, tag, stage)
     VALUES ($1, $2, $3, $4, $5, $6, $7)
     RETURNING *`,
    [userId, role, companyName, jobDescription, jobLink, tag, stage]
  );
